...
[`@kromatv/ui`](../ui/README.md) instead, at the level
...
```tsx
import { Box, Button, Text } from '@kromatv/ui/kit';        // the flat barrel
import { Button } from '@kromatv/ui/kit/atoms/button';      // one component
```
...
a consuming app imports `@kromatv/ui/css` and the tokens arrive as custom

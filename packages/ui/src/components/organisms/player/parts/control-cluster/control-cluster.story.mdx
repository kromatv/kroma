...
<Scene name="Boosted" args={{ volume: 1.6, focused: 'volume' }}>
  Past the dot at 100%, into the half of the rail the platform can boost. The rail is linear in the level the viewer reads; the loudness curve is the platform's.
</Scene>

...
import type { NotificationsView } from '@kromatv/client/notifications';
...
vi.mock('@kromatv/client/events', async (importOriginal) => {
  class KromaEvents {
  ...
  return { ...(await importOriginal<typeof import('@kromatv/client/events')>()), KromaEvents };
});
